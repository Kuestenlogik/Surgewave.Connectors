...
public class BatchingSinkConnectorTests
{
    [Fact]
    public void Version_ReturnsExpectedVersion()
    {
        using var connector = new BatchingSinkConnector();
        Assert.Equal("1.0.0", connector.Version);
    }

    [Fact]
    public void TaskClass_ReturnsBatchingSinkTask()
    {
        using var connector = new BatchingSinkConnector();
        Assert.Equal(typeof(BatchingSinkTask), connector.TaskClass);
    }
